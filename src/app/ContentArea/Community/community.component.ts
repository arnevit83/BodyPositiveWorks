...
export class CommunityComponent implements OnInit {
  ...
  this.titleService.setTitle( "Treat BoPo Works as your sanctuary… a place to unplug, pause & laugh." );
  this.meta.updateTag({ name: 'description', content: 'Holistic health & wellness center with a safe & joyous community at its heart. Feel good inside & out with our integrated services, programs, classes, & community activities. Meet up after class. Have a cup of tea in our Lila Lounge. Join our book club. Or just enjoy being in a space that enables you to be you.' });
